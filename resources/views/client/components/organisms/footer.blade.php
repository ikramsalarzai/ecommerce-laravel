        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/about#shippingandreturns" class="text-decoration-none text-dark">Shipping &
                            Returns</a></li>
            ...
            <div class="col-lg-2 col-md-2 col-6 d-flex flex-column align-items-center">
                ...
                {{-- <p class="mb-2"><img src="{{ asset('client/img/icon-phone.png') }}" alt=""
                        class="img-fluid me-2">{{ $shop->phone }}</p>
                <p class="mb-2"><img src="{{ asset('client/img/icon-email.png') }}" alt=""
                        class="img-fluid me-2">hello{!! '@' . str_replace(' ', '', strtolower($shop->name_shop)) !!}.com</p> --}}
                <div class="d-lg-block d-md-block d-none">
                    <div class="row">
                        <div class="col-6">
                            <a href="https://www.instagram.com/">
                                <img src="{{ asset('client/img/icon-instagram.png') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
